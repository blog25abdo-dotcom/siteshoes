          ...
          {selectedMessage ? (
            <div className="bg-white rounded-xl shadow-md">
                    ...
                    <div className="space-y-1 text-sm text-gray-600">
                      ...
                      {selectedMessage.productId && (
                        <div className="flex items-center space-x-2">
                          ...
                          <span>Chaussures: {getProductName(selectedMessage.productId)}</span>
                        </div>
                      )}
              ...
              <div className="p-6">
                ...
                {selectedMessage.productId && (
                  <div className="mt-6">
                    <h3 className="text-lg font-semibold text-gray-800 mb-4">Chaussures concernées:</h3>
                    {(() => {
                      ...
                      if (product) {
                        ...
                        return (
                          <div className="bg-gray-50 rounded-lg p-4">
                            <p className="text-gray-600">Produit supprimé ou introuvable</p>
                          </div>
                        );
                      }
                    })()}
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  ...
                  <div className="flex space-x-4">
                    <a
                      href={`mailto:${selectedMessage.email}?subject=Re: Votre demande chez Optique Store`}
