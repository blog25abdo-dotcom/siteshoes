...
const DashboardPage: React.FC = () => {
  ...
  const stats = [
    ...
    {
      title: 'Chaussures Vendues',
      value: state.messages.filter(m => m.orderStatus === 'received').length,
      icon: ShoppingBag,
    ...
    },
    {
      ...
      value: `${state.messages
        ...
        .reduce((total, m) => total + (m.orderPrice || 0), 0)} DH`,
      icon: TrendingUp,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className={`fixed inset-y-0 left-0 w-72 bg-white shadow-2xl z-30 border-r border-slate-200 transform transition-transform duration-300 ease-in-out ${
        ...
        <div className="flex flex-col h-full">
          {/* Header */}
          <div className="px-8 py-8 bg-gradient-to-br from-orange-900 to-red-900">
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center space-x-2 flex-shrink-0">
                ...
                <button
                  ...
                  className="p-2 text-slate-300 hover:text-white hover:bg-red-500/20 rounded-lg transition-all duration-300"
                  title="Déconnexion"
                >
          ...
          {/* User info */}
          <div className="px-8 py-6 bg-gradient-to-r from-red-600 to-pink-600 border-b border-slate-200">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-blue-100 font-medium">Administrateur</p>
              </div>
            </div>
          </div>
              ...
              <Link
                ...
                className={`flex items-center justify-between px-6 py-4 rounded-2xl transition-all duration-300 group ${
                  isActive(item.path, item.exact)
                    ...
                    : 'text-slate-600 hover:bg-gradient-to-r hover:from-slate-100 hover:to-orange-50 hover:text-orange-600'
                }`}
              >
                <div className="flex items-center">
                  <item.icon className={`w-6 h-6 mr-4 ${
                    isActive(item.path, item.exact) ? 'text-white' : 'group-hover:text-orange-600'
                  }`} />
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <h1 className="text-lg font-bold text-slate-800 mb-1">Shoes</h1>
                  <h2 className="text-2xl font-bold text-slate-800">Administration</h2>
                  <p className="text-slate-600 mt-1">Shoes Paradise</p>
                </div>
                <div className="flex items-center space-x-2 flex-shrink-0">
                  <Link
                    to="/"
                    className="p-2 text-slate-600 hover:text-orange-600 hover:bg-orange-50 rounded-lg transition-all duration-300"
                    title="Retour à l'accueil"
                  >
                    <Home className="w-5 h-5" />
                  </Link>
              ...
              {sidebarItems.map(item => (
                <Link
                  ...
                  className={`relative p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 ${
                    isActive(item.path, item.exact)
                      ? 'ring-2 ring-orange-500 bg-gradient-to-br from-orange-50 to-red-50'
                      : 'hover:bg-gray-50'
                  }`}
                >
                  <div className="flex flex-col items-center text-center space-y-3">
                    ...
                    <span className={`font-semibold ${
                      isActive(item.path, item.exact) ? 'text-orange-600' : 'text-slate-700'
                    }`}>
                      {item.label}
                    </span>
                    {item.badge && item.badge > 0 && (
            ...
            <>
              ...
              <div className="mb-12 hidden lg:block">
                ...
                <p className="text-xl text-slate-600">
                  Vue d'ensemble de votre magasin de chaussures Shoes Paradise
                </p>
              </div>
                ...
                {stats.map((stat, index) => (
                  <div key={index} className="bg-white rounded-3xl shadow-xl p-6 lg:p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <div className={`w-12 h-12 lg:w-16 lg:h-16 bg-gradient-to-br ${stat.bgGradient} rounded-2xl flex items-center justify-center shadow-lg`}>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10">
                ...
                <div className="bg-white rounded-3xl shadow-xl p-6 lg:p-8">
                  <div className="flex items-center mb-8">
                    <div className="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl flex items-center justify-center mr-4 shadow-lg">
                  ...
                  <div className="space-y-6">
                    {state.products.slice(0, 5).map(product => (
                      <div key={product.id} className="flex items-center space-x-4 p-4 bg-gradient-to-r from-slate-50 to-orange-50 rounded-2xl hover:shadow-md transition-all duration-300">
                        <img
                          ...
                          <p className="text-slate-600 text-sm">
                            {product.discount ? (
                              <span>
                                ...
                                <span className="text-orange-600 font-bold ml-2">{product.price} DH</span>
                              </span>
                            ) : (
                              `${product.price} DH`
                            )}
                  ...
                  <Link
                    ...
                    className="block text-center bg-gradient-to-r from-orange-600 to-red-600 text-white font-bold py-3 lg:py-4 rounded-2xl mt-8 hover:from-orange-700 hover:to-red-700 transition-all duration-300 transform hover:scale-105 shadow-lg text-sm lg:text-base"
                  >
                ...
                <div className="bg-white rounded-3xl shadow-xl p-6 lg:p-8">
                  <div className="flex items-center mb-8">
                    <div className="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-br from-red-500 to-pink-600 rounded-2xl flex items-center justify-center mr-4 shadow-lg">
                  ...
                  <div className="space-y-6">
                    {state.messages.slice(0, 5).map(message => (
                      <div key={message.id} className="border-l-4 border-red-500 pl-6 p-4 bg-gradient-to-r from-slate-50 to-red-50 rounded-r-2xl hover:shadow-md transition-all duration-300">
                  ...
                  <Link
                    ...
                    className="block text-center bg-gradient-to-r from-red-600 to-pink-600 text-white font-bold py-3 lg:py-4 rounded-2xl mt-8 hover:from-red-700 hover:to-pink-700 transition-all duration-300 transform hover:scale-105 shadow-lg text-sm lg:text-base"
                  >
                ...
                <div className="bg-white rounded-3xl shadow-xl p-6 lg:p-8">
                  <div className="flex items-center mb-8">
                    <div className="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-br from-pink-500 to-purple-600 rounded-2xl flex items-center justify-center mr-4 shadow-lg">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl hover:shadow-md transition-all duration-300">
                      <div className="flex items-center space-x-4">
                        <Send className="w-5 h-5 lg:w-6 lg:h-6 text-blue-500" />
                        <span className="text-sm lg:text-lg font-bold text-blue-700">Devis Envoyés</span>
                      </div>
                      <span className="text-xl lg:text-2xl font-bold text-blue-600">
                        {state.messages.filter(m => m.orderStatus === 'sent').length}
                      </span>
                    </div>
                    <div className="flex items-center justify-between p-6 bg-gradient-to-r from-green-50 to-teal-50 rounded-2xl hover:shadow-md transition-all duration-300">
                      <div className="flex items-center space-x-4">
                        <CheckCircle className="w-5 h-5 lg:w-6 lg:h-6 text-green-500" />
                        <span className="text-sm lg:text-lg font-bold text-green-700">Vendues</span>
                      </div>
                      <span className="text-xl lg:text-2xl font-bold text-green-600">
                        {state.messages.filter(m => m.orderStatus === 'received').length}
                      </span>
                    </div>
                    <div className="flex items-center justify-between p-6 bg-gradient-to-r from-red-50 to-pink-50 rounded-2xl hover:shadow-md transition-all duration-300">
                      <div className="flex items-center space-x-4">
                        ...
                        <span className="text-sm lg:text-lg font-bold text-red-700">Refusées</span>
                      </div>
                      <span className="text-xl lg:text-2xl font-bold text-red-600">
                        {state.messages.filter(m => m.orderStatus === 'cancelled').length}
                      </span>
                    </div>
                    <div className="pt-6 border-t-2 border-slate-200">
                      <div className="flex items-center justify-between p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl">
                        <div className="flex items-center justify-between p-4 bg-gradient-to-r from-teal-50 to-green-50 rounded-2xl">
