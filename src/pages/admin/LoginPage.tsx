  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-cyan-50 to-blue-50 flex items-center justify-center p-4">
      ...
      <div className="fixed top-6 left-6 z-10">
        <a
          href="/"
          className="flex items-center space-x-2 bg-white/90 backdrop-blur-sm text-orange-600 px-4 py-3 rounded-xl hover:bg-white hover:shadow-lg transition-all duration-300 font-medium shadow-md"
        >
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-orange-100">
          ...
          <div className="bg-gradient-to-r from-orange-600 to-red-600 px-8 py-8">
            ...
            <div className="text-center">
              ...
              <h1 className="text-3xl font-bold text-white mb-2">Administration Chaussures</h1>
              <p className="text-orange-100 text-lg font-medium">Shoes Paradise</p>
              <p className="text-orange-200 text-sm mt-2">Gestion professionnelle de votre magasin de chaussures</p>
            </div>
          </div>
          ...
          <div className="px-8 py-10">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-orange-600 to-red-600 text-white py-4 rounded-xl font-bold hover:from-orange-700 hover:to-red-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center transform hover:scale-105 shadow-lg"
              >
                {isLoading ? (
                  <>
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-slate-600 font-medium">
                Accédez à la gestion complète de votre magasin de chaussures
              </p>
            </div>
          </div>
        </div>
