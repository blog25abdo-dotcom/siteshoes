...
const ProductsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-orange-900 via-red-900 to-pink-800 py-16">
        <div className="container mx-auto px-4">
          <div className="text-center text-white space-y-6">
            <h1 className="text-4xl lg:text-5xl font-bold">
              {state.selectedCategory ? getCategoryName(state.selectedCategory) : 'Nos Chaussures'}
            </h1>
            <p className="text-xl text-gray-200 max-w-2xl mx-auto">
              Découvrez {filteredProducts.length} modèle{filteredProducts.length > 1 ? 's' : ''} 
              {state.selectedCategory ? ` dans la catégorie ${getCategoryName(state.selectedCategory)}` : ' dans notre gamme chaussures'}
            </p>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="relative">
                <input
                  ...
                  className="w-full px-6 py-4 pl-12 pr-16 rounded-full text-gray-900 bg-white/95 backdrop-blur-sm focus:outline-none focus:ring-4 focus:ring-white/30 text-lg"
                />
                <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 w-6 h-6 text-gray-400" />
                <button
                  onClick={handleSearch}
                  className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-orange-600 text-white px-6 py-2 rounded-full hover:bg-orange-700 transition-colors font-medium"
                >
                  Rechercher
                </button>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-24">
              ...
              <div className={`space-y-8 ${showFilters ? 'block' : 'hidden lg:block'}`}>
                  ...
                  <div className="space-y-4">
                    <div className="px-4">
                      <input
                        ...
                        style={{
                          background: `linear-gradient(to right, #ea580c 0%, #ea580c ${(priceRange[1]/3000)*100}%, #e5e7eb ${(priceRange[1]/3000)*100}%, #e5e7eb 100%)`
                        }}
                      />
                    </div>
                ...
                <button
                  ...
                  className="w-full py-3 text-orange-600 hover:text-orange-700 font-semibold border border-orange-200 hover:border-orange-300 rounded-xl transition-colors flex items-center justify-center space-x-2"
                >
                  <X className="w-4 h-4" />
          ...
          <div className="flex-1">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div className="flex items-center space-x-4">
                  ...
                  <select
                    ...
                    className="border border-gray-300 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300 bg-white"
                  >
            ...
            {filteredProducts.length > 0 ? (
              ...
              <div className="bg-white rounded-2xl shadow-lg p-16 text-center">
                ...
                <button
                  onClick={clearFilters}
                  className="bg-gradient-to-r from-orange-600 to-red-600 text-white px-8 py-4 rounded-full hover:from-orange-700 hover:to-red-700 transition-all duration-300 font-semibold transform hover:scale-105"
                >
