        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600 leading-relaxed text-base">
             Votre spécialiste en chaussures avec plus de 15 ans d'expérience.
             Découvrez notre large gamme de sneakers, chaussures de ville, sport et accessoires.
            </p>
            <div className="flex space-x-4 pt-2">
  {/* Instagram */}
  <a
    href="https://www.instagram.com/shoes_paradise/"
    target="_blank"
    rel="noopener noreferrer"
    className="w-10 h-10 bg-gradient-to-br from-orange-100 to-red-100 rounded-full hover:from-orange-200 hover:to-red-200 transition-colors flex items-center justify-center"
  >
    <svg
      ...
      <path d="M22 12a10 10 0 10-11.5 9.9v-7H8v-3h2.5v-2c0-2.5 1.5-3.9 3.8-3.9 1.1 0 2.2.2 2.2.2v2.4h-1.2c-1.2 0-1.6.7-1.6 1.5v1.8H18l-.5 3h-2.7v7A10 10 0 0022 12z" />
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="/products" className="text-gray-600 hover:text-orange-600 transition-colors text-base font-medium">
                  Nos Chaussures
                </a>
              </li>
              <li>
                <a href="/contact" className="text-gray-600 hover:text-orange-600 transition-colors text-base font-medium">
                  Contact
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-5">
              <div className="flex items-center space-x-4">
                ...
                <span className="text-gray-600 text-base">Rabat, Maroc</span>
              </div>
              <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-4">
                ...
                <span className="text-gray-600 text-base">contact@shoesparadise.ma</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 mt-12 pt-10">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 text-base">
              © 2024 Shoes Paradise. Tous droits réservés.
            </p>
            <div className="flex space-x-8 mt-6 md:mt-0">
              <a href="#" className="text-gray-600 hover:text-orange-600 text-base transition-colors">
